// components/StudentDocumentModal.tsx
...
const StudentDocumentModal = ({ userId, isOpen, onClose }: Props) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="max-h-[80vh] overflow-y-auto bg-gray-900 p-6 rounded-xl">
