...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/labels/{companyID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/LabelsPagination"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Label query params",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/LabelsIn"
                        }
                    }
                ],
                "responses": {
        ...
        "/labels/{companyID}/count": {
            "get": {
                ...
                "description": "Get number of all labels.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "LabelsCount": {
            "description": "LabelsCount represents the count of labels.",
            "type": "object",
            "properties": {
                "count": {
                    "description": "Count is the number of labels.",
                    "type": "integer"
                }
            }
        },
        "LabelsDetails": {
            "description": "LabelsDetails represents detailed information about a specific label.",
            "type": "object",
            "properties": {
                "color": {
                ...
                "companyID": {
                    "description": "CompanyID is the unique identifier for the company associated with the label.",
                    "type": "string"
                },
                "companyName": {
                    "description": "CompanyName is the name of the company associated with the label.",
                    "type": "string"
                },
                "createdAt": {
                    "description": "CreatedAt is the timestamp indicating when the label entry was created.",
                    "type": "string"
                },
                "description": {
        ...
        "LabelsIn": {
            "description": "LabelsIn represents the input structure for creating a new label.",
            "type": "object",
            "required": [
                "Description",
                "color",
            ...
            "properties": {
                ...
                "name": {
                    "description": "Name is the name of the label. It is required and should be between 2 and 40 characters.",
                    "type": "string",
                    "maxLength": 40,
                    "minLength": 2
                }
        ...
        "LabelsList": {
            "description": "LabelsList represents a simplified version of the label for listing purposes.",
            "type": "object",
            "properties": {
                "color": {
                    "description": "Color of the label",
        ...
        "LabelsPagination": {
            "description": "LabelsPagination represents the paginated list of labels.",
            "type": "object",
            "properties": {
                "items": {
                    "description": "Items is a slice containing individual label details.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/LabelsTable"
                    }
                },
                "limit": {
                    "description": "Limit is the maximum number of items per page in the pagination.",
                ...
                "totalCount": {
                    "description": "TotalCount is the total number of labels in the entire list.",
                    "type": "integer"
                }
            }
        },
        "LabelsTable": {
            "description": "LabelsTable represents a single label entry in a table.",
            "type": "object",
            "properties": {
                "color": {
                    "description": "Color of the label",
